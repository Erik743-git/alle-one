...
import { AppointmentViewDialog } from "@/components/tickets/appointment-view-dialog";
...
function TicketDetailPageImpl() {
  ...
  /** Leitura do apontamento de quem nao pode editar. */
  const [appointmentToView, setAppointmentToView] =
    useState<TicketAppointment | null>(null);
                ...
                {canCreateTicketAppointment() ? (
                  <>
                    ...
                    <AppointmentViewDialog
                      ...
                      onOpenChange={(open) => {
                        if (!open) setAppointmentToView(null);
                      }}
                      onOpenAttachment={(attachment, inline) => {
                        void openPortalAttachment(attachment, inline);
                      }}
                    />
...
export { TicketDetailPageImpl as PortalPageComponent };
