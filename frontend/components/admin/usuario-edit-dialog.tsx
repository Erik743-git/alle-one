          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            {form.role === "PJ" ? (
              <div className="space-y-2 sm:col-span-2">
                ...
                <p className="text-xs text-muted-foreground">
                  O terceiro vê os chamados destas empresas nas especialidades
                  marcadas abaixo, além dos chamados em que ele participa. Sem
                  nenhuma empresa marcada, vê só os chamados dele.
                </p>
                <div className="max-h-48 space-y-1 overflow-y-auto rounded-xl border border-border bg-muted/20 p-2">
                  {carregandoEmpresas ? (
                    ...
                    empresas.map((empresa) => {
                      const selected = form.servedCompanyIds.includes(
                        empresa.id,
                      );
                      return (
                        <button
                          ...
                          onClick={() =>
                            onFormChange((prev) => ({
                              ...prev,
                              servedCompanyIds: selected
                                ? prev.servedCompanyIds.filter(
                                    (id) => id !== empresa.id,
                                  )
                                : [...prev.servedCompanyIds, empresa.id],
                            }))
                          }
            ...
            <div className="space-y-2 sm:col-span-2">
              ...
              <p className="text-xs text-muted-foreground">
                Usuários marcados como responsável aparecem em tickets e
